...
import com.example.team.comearnapp.util.PasswordCheckUtil;
...
import com.example.team.comearnapp.util.Retrofit.callback.AbstractRegisterHttpCallback;
...
public class ForgetPasswordActivity extends AppCompatActivity {
    @BindView(R2.id.forget_password_account_edt)
    EditText edtForgetAccount;
    @BindView(R2.id.forget_password_input_verification_code_edt)
    EditText edtInputVerCode;
    @BindView(R2.id.forget_password_get_verification_code_bt)
    Button btGetVerCode;
    @BindView(R2.id.forget_password_password_edt)
    EditText edtNewPassword;
    @BindView(R2.id.forget_password_finish_bt)
    Button btFinish;
    @BindView(R2.id.forget_password_eye_img)
    ...
    @OnClick(R2.id.forget_password_get_verification_code_bt)
    ...
    @OnClick(R2.id.forget_password_finish_bt)
     ...
     * 点击眼睛图片显示密码
     */
    @OnClick(R2.id.forget_password_eye_img)
    void onClickEyeImg() {
        if (!isEyeImgOpened) {
